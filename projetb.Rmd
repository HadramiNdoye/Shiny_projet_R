...
Au terme de cette étude on peut dire que les facteurs (variable) qui sont liés ou qui contribuent le plus à la crise systémique ("systemic_crisis") en Afrique notamment dans le cas des 13 pays sont : 
